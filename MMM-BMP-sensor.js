    ...
    getDom: function () {
        ...
        if (this.config.showTableBmpInfo) {
            ...
            if (this.config.showPressureRow){
                ...
                pressureCell2.innerHTML = lastBmpData.bmpData.pressure + " hPa";
